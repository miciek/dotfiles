...
(function() {
  ...
  HS = function() {
    return require('../hs/HaskellCabal.min.js');
  };
  ...
  module.exports = Util = {
    isDirectory: function(dir) {
      var ref1;
      switch (false) {
        case !((dir instanceof Directory) || (dir instanceof File)):
    ...
    getRootDir: function(bufferOrFileOrString) {
      ...
      file = (function() {
        switch (false) {
          ...
          case !(bufferOrFileOrString instanceof File):
            return bufferOrFileOrString;
          case typeof bufferOrFileOrString !== 'string':
            return new File(bufferOrFileOrString);
        }
      })();
      dir = (ref1 = file != null ? typeof file.getParent === "function" ? file.getParent() : void 0 : void 0) != null ? ref1 : Util.getRootDirFallback(file);
